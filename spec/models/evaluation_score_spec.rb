...
RSpec.describe EvaluationScore, type: :model do
  ...
  #   let_it_be(:project_evaluation, reload: true) { create(:project_evaluation, evaluation_program: program) }
  ...
  #       expect(project_evaluation.total_score).to eq(0)

  #       create(:evaluation_score, total: 70, program_criterium: program_criterium, project_evaluation: project_evaluation)

  #       expect(project_evaluation.reload.total_score).to eq(70)
  #     end

  #     it 'triggers an update of the Summarys scores' do
  #       pending 'RE-DO TAKING INTO CONSIDERATION THE DIFFERENT POSSIBLE CALCULATION METHODS!'
  #       expect(project_evaluation.scores).to eq({})

  #       score = create(:evaluation_score, total: 70, program_criterium: program_criterium, project_evaluation: project_evaluation)

  #       expect(project_evaluation.scores[score.name]).to eq(score.score_summary)
  #     end
  #   end

  #   context 'on update' do
  #     let!(:score) { create(:evaluation_score, total: 70, program_criterium: program_criterium, project_evaluation: project_evaluation) }

  #     it 'triggers a reevaluation of the Summarys total_score' do
  #       pending 'RE-DO TAKING INTO CONSIDERATION THE DIFFERENT POSSIBLE CALCULATION METHODS!'
  #       expect(project_evaluation.total_score).to eq(70)

  #       score.update(total: 80)

  #       expect(project_evaluation.reload.total_score).to eq(80)
  #     end
  ...
  #       expect(project_evaluation.reload.total_score).to eq(0)
  #     end
  ...
  #       expect(project_evaluation.scores[score.name]['weighed_points']).to eq(0)
  #     end
  #   end
  # end
end
